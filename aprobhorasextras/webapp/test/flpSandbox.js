		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Distribución y Aprobación de Horas Extras",
									"targetURL": "#AprobHorasExtrasaprobhorasextras-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AprobHorasExtrasaprobhorasextras-display": {
								"semanticObject": "AprobHorasExtrasaprobhorasextras",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Aprob.Horas.Extras.aprobhorasextras",
									"url": sap.ui.require.toUrl("Aprob/Horas/Extras/aprobhorasextras")
								}
							}
						}
					}
