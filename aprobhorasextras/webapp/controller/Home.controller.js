sap.ui.define([
	"Aprob/Horas/Extras/aprobhorasextras/controller/BaseController",
	...
	return BaseController.extend("Aprob.Horas.Extras.aprobhorasextras.controller.Home", {
			...
			oModel2.create("/sendDistributionSet", data, {
				success: function (result) {
					setTimeout(function () {
						sap.ui.core.BusyIndicator.hide();
						sap.this.onSearch();
						MessageBox.success("Se envió con éxito!");
					}, 3000);
				},
				error: function (err) {
					sap.ui.core.BusyIndicator.hide();
		...
		onSearch: function (oEvent) {
			...
			//var oModel2 = new sap.ui.model.odata.v2.ODataModel("/ERP/odata/SAP/ZPT_PY_SOLICITUDES_SRV/");
            var oModel2 = new sap.ui.model.odata.v2.ODataModel("./ERP/sap/opu/odata/sap/ZPT_PY_SOLICITUDES_SRV/");
