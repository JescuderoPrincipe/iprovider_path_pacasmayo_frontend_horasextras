		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Liberar HHEE",
									"targetURL": "#AprobHorasExtrasaprobhorasextras2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AprobHorasExtrasaprobhorasextras2-display": {
								"semanticObject": "AprobHorasExtrasaprobhorasextras2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Aprob.Horas.Extras.aprobhorasextras2",
									"url": sap.ui.require.toUrl("Aprob/Horas/Extras/aprobhorasextras2")
								}
							}
						}
					}
