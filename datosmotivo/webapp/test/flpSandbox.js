		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DatosMotivo",
									"targetURL": "#DatosMotivodatosmotivo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"DatosMotivodatosmotivo-display": {
								"semanticObject": "DatosMotivodatosmotivo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=DatosMotivo.datosmotivo",
									"url": sap.ui.require.toUrl("DatosMotivo/datosmotivo")
								}
							}
						}
					}
