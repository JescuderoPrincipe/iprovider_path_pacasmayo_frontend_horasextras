		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "AgenGestHuma",
									"targetURL": "#AgenGestHumaagengesthuma-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AgenGestHumaagengesthuma-display": {
								"semanticObject": "AgenGestHumaagengesthuma",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=AgenGestHuma.agengesthuma",
									"url": sap.ui.require.toUrl("AgenGestHuma/agengesthuma")
								}
							}
						}
					}
