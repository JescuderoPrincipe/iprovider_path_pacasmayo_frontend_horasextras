		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CP_GESTION_STOCK",
									"targetURL": "#comcementospacasmayocpgestionstock-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcementospacasmayocpgestionstock-display": {
								"semanticObject": "comcementospacasmayocpgestionstock",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.cementos.pacasmayo.cpgestionstock",
									"url": sap.ui.require.toUrl("com/cementos/pacasmayo/cpgestionstock")
								}
							}
						}
					}
