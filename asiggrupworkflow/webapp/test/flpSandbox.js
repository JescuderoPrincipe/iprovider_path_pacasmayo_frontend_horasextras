		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "AsigGrupWorkFlow",
									"targetURL": "#AsigGrupWorkFlowasiggrupworkflow-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AsigGrupWorkFlowasiggrupworkflow-display": {
								"semanticObject": "AsigGrupWorkFlowasiggrupworkflow",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=AsigGrupWorkFlow.asiggrupworkflow",
									"url": sap.ui.require.toUrl("AsigGrupWorkFlow/asiggrupworkflow")
								}
							}
						}
					}
