		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TablaWorkFlows",
									"targetURL": "#TablaWorkFlowstablaworkflows-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"TablaWorkFlowstablaworkflows-display": {
								"semanticObject": "TablaWorkFlowstablaworkflows",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=TablaWorkFlows.tablaworkflows",
									"url": sap.ui.require.toUrl("TablaWorkFlows/tablaworkflows")
								}
							}
						}
					}
