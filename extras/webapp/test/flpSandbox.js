		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#repoHorasextras-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"repoHorasextras-display": {
								"semanticObject": "repoHorasextras",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=repo.Horas.extras",
									"url": sap.ui.require.toUrl("repo/Horas/extras")
								}
							}
						}
					}
