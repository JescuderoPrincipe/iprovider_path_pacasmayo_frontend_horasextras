		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Procesar HHEE",
									"targetURL": "#AprobHorasExtrasaprobhorasextras3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AprobHorasExtrasaprobhorasextras3-display": {
								"semanticObject": "AprobHorasExtrasaprobhorasextras3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Aprob.Horas.Extras.aprobhorasextras3",
									"url": sap.ui.require.toUrl("Aprob/Horas/Extras/aprobhorasextras3")
								}
							}
						}
					}
