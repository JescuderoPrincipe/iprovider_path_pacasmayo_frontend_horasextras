		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ManteGrupos",
									"targetURL": "#ManteGruposmantegrupos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ManteGruposmantegrupos-display": {
								"semanticObject": "ManteGruposmantegrupos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ManteGrupos.mantegrupos",
									"url": sap.ui.require.toUrl("ManteGrupos/mantegrupos")
								}
							}
						}
					}
