		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ReporteTrabjador",
									"targetURL": "#ReporteTrabjadorreportetrabajador-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ReporteTrabjadorreportetrabajador-display": {
								"semanticObject": "ReporteTrabjadorreportetrabajador",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ReporteTrabjador.reportetrabajador",
									"url": sap.ui.require.toUrl("ReporteTrabjador/reportetrabajador")
								}
							}
						}
					}
