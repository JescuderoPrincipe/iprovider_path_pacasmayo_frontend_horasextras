		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "aprobHorasExtras",
									"targetURL": "#repoHorasextras2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"repoHorasextras2-display": {
								"semanticObject": "repoHorasextras2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=repo.Horas.extras2",
									"url": sap.ui.require.toUrl("repo/Horas/extras2")
								}
							}
						}
					}
